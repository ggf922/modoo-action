  ...
  <section id="hero" class="relative rounded-3xl overflow-hidden mb-8 bg-gradient-to-br from-brand-orange to-red-500 text-white p-8 sm:p-12">
    <div id="hero-external-links" class="relative z-20 grid grid-cols-1 sm:grid-cols-2 gap-2.5 mb-5 sm:mb-0 sm:absolute sm:top-6 sm:right-6 sm:w-[420px]">
      ...
      <a href="https://modoomodoo.fun/distribution-program" target="_blank" rel="noopener noreferrer"
         class="w-full inline-flex items-center justify-center gap-1.5 bg-gradient-to-r from-teal-500 to-emerald-500 text-white font-bold px-4 py-2.5 rounded-xl text-sm shadow-md hover:from-teal-600 hover:to-emerald-600 transition whitespace-nowrap">
