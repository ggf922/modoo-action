...
async function pageHome() {
  ...
  <section id="hero" class="relative rounded-3xl overflow-hidden mb-8 bg-gradient-to-br from-brand-orange to-red-500 text-white p-8 sm:p-12">
    <div id="hero-external-links" class="relative z-20 grid grid-cols-3 gap-2 mb-5 sm:mb-0 sm:absolute sm:top-6 sm:right-6 sm:w-[360px]">
      <a href="https://modoomodoo.fun/" target="_blank" rel="noopener noreferrer"
         class="inline-flex items-center justify-center gap-1.5 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-bold px-3 py-2.5 rounded-xl text-sm shadow-md hover:from-purple-600 hover:to-pink-600 transition whitespace-nowrap">
