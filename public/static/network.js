...
async function pageNetwork() {
  ...
  allNodes.forEach(n => {
    ...
    const fill = isRoot ? '#FFC107' : '#60a5fa'
  ...
  <div class="grid lg:grid-cols-3 gap-4">
    <div class="lg:col-span-2 bg-white rounded-2xl border border-gray-100 p-4 overflow-auto">
      <div class="flex gap-3 text-xs text-gray-500 mb-3">
        <span><span class="inline-block w-3 h-3 rounded bg-brand-gold align-middle"></span> 본인</span>
        <span><span class="inline-block w-3 h-3 rounded bg-blue-400 align-middle"></span> 하위 회원</span>
      </div>
      ${totalDownline === 0
