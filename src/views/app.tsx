...
<body class="bg-gray-50 text-brand-dark min-h-screen">
  ...
  <script src="/static/api.js?v=20260820a"></script>
  <script src="/static/i18n.js?v=20260820a"></script>
  <script src="/static/i18n-dict.js?v=20260820a"></script>
  <script src="/static/components.js?v=20260820a"></script>
  <script src="/static/pages.js?v=20260820a"></script>
  <script src="/static/mypage.js?v=20260820a"></script>
  <script src="/static/network.js?v=20260820a"></script>
  <script src="/static/admin.js?v=20260820a"></script>
